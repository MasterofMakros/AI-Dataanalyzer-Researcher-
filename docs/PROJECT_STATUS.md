...
| F-005 | Perplexica UI E2E Tests (PRP-UI-002) | Implemented / Pending Validation | ../PRPs/prp-ui-002-perplexica-ui-e2e-tests.md | F-004 | `npm run test:e2e`; Evidence: `.agents/plans/2026-01-15_ui-002_runtime_evidence.md` (failed; smart_ingest exit=1; UI build lockfile mismatch; E2E run from repo root) |
