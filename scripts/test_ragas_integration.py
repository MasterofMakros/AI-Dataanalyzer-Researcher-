...
data_samples = {
    ...
    'contexts': [['Neural Vault ist ein Projekt zur Transformation eines passiven 10TB-Archivs in ein aktives, durchsuchbares System mittels lokaler KI auf einem Ryzen AI Node.']],
