...
import { LocalMessageSources } from './LocalSources';
...
const MessageBox = ({
  ...
  const webSearchEnabled = enabledSources.includes('web');
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col space-y-9 lg:space-y-0 lg:flex-row lg:justify-between lg:space-x-9">
        ...
        {/* Media sidebar - Local and/or Web */}
        {hasContent && (webSearchEnabled || localSources.length > 0) && (
          <div className="lg:sticky lg:top-20 flex flex-col items-center space-y-3 w-full lg:w-3/12 z-30 h-full pb-4">
            {/* Local Media Preview with timecodes */}
            {localSources.length > 0 && (
              <LocalMediaPreview
            ...
            {/* Web Image/Video search - only show when Web source is enabled */}
            {webSearchEnabled && (
              <>
                <SearchImages
                  query={section.message.query}
